    ...
    feed.innerHTML += `
      <div class="post">
        ...
        <div class="actions">
          ...
          <button onclick="react(${i}, 'laugh')">ðŸ˜‚ ${p.reactions.laugh}</button>
          <button onclick="react(${i}, 'wow')">ðŸ˜® ${p.reactions.wow}</button>
          <button onclick="react(${i}, 'fire')">ðŸ”¥ ${p.reactions.fire}</button>
        </div>
